...
class StudioLoadTestExecutorController extends BaseController
{
    ...
    public function submitDispatches(Request $request): JsonResponse
    {
        ...
        return $this->sendResponse($result, 'Load test dispatches submitted successfully.');
    }
}
