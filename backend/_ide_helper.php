...
namespace DefStudio\Telegraph\Facades {
    ...
    class Telegraph {
         ...
         * @static
         */
        public static function withEndpoint($endpoint)
        {
            /** @var \DefStudio\Telegraph\Telegraph $instance */
            return $instance->withEndpoint($endpoint);
        }
         ...
         * @static
         */
        public static function inBusiness($business_connection_id)
        {
            /** @var \DefStudio\Telegraph\Telegraph $instance */
            return $instance->inBusiness($business_connection_id);
        }
         ...
         * @static
         */
        public static function setHttpProxy($proxy)
        {
            /** @var \DefStudio\Telegraph\Telegraph $instance */
            return $instance->setHttpProxy($proxy);
        }
         ...
         * @static
         */
        public static function readBusinessMessage($messageId)
        {
            /** @var \DefStudio\Telegraph\Telegraph $instance */
            return $instance->readBusinessMessage($messageId);
        }
         ...
         * @static
         */
        public static function deleteBusinessMessages($messageIds)
        {
            /** @var \DefStudio\Telegraph\Telegraph $instance */
            return $instance->deleteBusinessMessages($messageIds);
        }
         ...
         * @static
         */
        public static function videoNote($path, $thumbnail = null)
        {
            /** @var \DefStudio\Telegraph\Telegraph $instance */
            return $instance->videoNote($path, $thumbnail);
        }
         ...
         * @static
         */
        public static function game($shortName)
        {
            /** @var \DefStudio\Telegraph\Telegraph $instance */
            return $instance->game($shortName);
        }
         ...
         * @static
         */
        public static function refundStarPayment($userId, $telegramPaymentChargeId)
        {
            /** @var \DefStudio\Telegraph\Telegraph $instance */
            return $instance->refundStarPayment($userId, $telegramPaymentChargeId);
        }
